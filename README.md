...
> **You are on the `ort-1.19` branch** — ONNX Runtime 1.19.2 + CUDA 12.4/12.9 + Driver 550+/560+ (50 variants)
...
| cpuinfo | ca67895 | — | Bundled via `FETCHCONTENT_SOURCE_DIR_PYTORCH_CPUINFO` |
...
Python version is paired with CUDA toolkit version: Python 3.12 for CUDA 12.4 variants, Python 3.13 for CUDA 12.9 and CPU-only variants.
