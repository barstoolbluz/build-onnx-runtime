...
Python version is paired with CUDA toolkit version: Python 3.12 for CUDA 12.4 variants (using `python312Packages`), Python 3.13 for CUDA 12.9 and CPU-only variants (using `python3Packages`).
...
description = "ONNX Runtime 1.19.2 for NVIDIA H100/L40S (SM90) + AVX-512 [CUDA 12.4]";
```
