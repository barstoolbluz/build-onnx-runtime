# ONNX Runtime 1.24.2 for NVIDIA Blackwell DC (SM100: B100/B200) + AVX-512
...
let
  ...
  variantName = "onnxruntime-python312-cuda12_4-sm100-avx512";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python312Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.24.2 for NVIDIA B100/B200 (SM100) + AVX-512 [CUDA 12.4]";
