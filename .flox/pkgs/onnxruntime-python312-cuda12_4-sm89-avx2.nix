# ONNX Runtime 1.23.2 for NVIDIA Ada (SM89: RTX 4090/L4/L40) + AVX2
...
let
  ...
  gpuArchCMake = "89";
  cpuFlags = [ "-mavx2" "-mfma" ];
  variantName = "onnxruntime-python312-cuda12_4-sm89-avx2";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python312Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.23.2 for NVIDIA RTX 4090/L4/L40 (SM89) + AVX2 [CUDA 12.4]";
