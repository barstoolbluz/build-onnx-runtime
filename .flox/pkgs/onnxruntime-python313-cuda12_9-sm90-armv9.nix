# ONNX Runtime 1.22.2 for NVIDIA Hopper (SM90: H100/Grace Hopper) + ARMv9 (Graviton3+, Grace)
...
let
  ...
  variantName = "onnxruntime-python313-cuda12_9-sm90-armv9";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.22.2 for NVIDIA H100/Grace Hopper (SM90) + ARMv9 (Graviton3+, Grace) [CUDA 12.9]";
