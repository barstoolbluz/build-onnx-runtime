# ONNX Runtime 1.20.1 for NVIDIA Turing (SM75: T4, RTX 2080 Ti) + AVX-512
...
let
  ...
  variantName = "onnxruntime-python313-cuda12_9-sm75-avx512";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.20.1 for NVIDIA T4/RTX 2080 Ti (SM75) + AVX-512 [CUDA 12.9]";
