# ONNX Runtime 1.24.2 for NVIDIA Blackwell DC (SM100: B100/B200) + AVX2
...
let
  ...
  gpuArchCMake = "100";
  cpuFlags = [ "-mavx2" "-mfma" ];
  variantName = "onnxruntime-python312-cuda12_4-sm100-avx2";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python312Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.24.2 for NVIDIA B100/B200 (SM100) + AVX2 [CUDA 12.4]";
