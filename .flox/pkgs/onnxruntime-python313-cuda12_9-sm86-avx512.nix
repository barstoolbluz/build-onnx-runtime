# ONNX Runtime 1.22.2 for NVIDIA Ampere (SM86: RTX 3090, A40) + AVX-512
...
let
  ...
  variantName = "onnxruntime-python313-cuda12_9-sm86-avx512";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.22.2 for NVIDIA RTX 3090/A40 (SM86) + AVX-512 [CUDA 12.9]";
