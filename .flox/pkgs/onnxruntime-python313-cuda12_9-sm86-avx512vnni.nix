# ONNX Runtime 1.23.2 for NVIDIA Ampere (SM86: RTX 3090/A40) + AVX-512 VNNI
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.23.2 for NVIDIA RTX 3090/A40 (SM86) + AVX-512 VNNI [CUDA 12.9]";
