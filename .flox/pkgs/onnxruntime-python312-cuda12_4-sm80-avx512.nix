# ONNX Runtime 1.24.2 for NVIDIA Ampere DC (SM80: A100/A30) + AVX-512
...
let
  ...
  variantName = "onnxruntime-python312-cuda12_4-sm80-avx512";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python312Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.24.2 for NVIDIA A100/A30 (SM80) + AVX-512 [CUDA 12.4]";
