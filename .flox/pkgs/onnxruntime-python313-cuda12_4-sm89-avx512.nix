# ONNX Runtime 1.19.2 for NVIDIA Ada (SM89: RTX 4090, L4, L40) + AVX-512
...
let
  ...
  variantName = "onnxruntime-python313-cuda12_4-sm89-avx512";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.19.2 for NVIDIA RTX 4090/L4/L40 (SM89) + AVX-512 [CUDA 12.4]";
