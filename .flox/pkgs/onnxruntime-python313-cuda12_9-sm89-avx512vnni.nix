# ONNX Runtime 1.22.2 for NVIDIA Ada (SM89: RTX 4090, L4, L40) + AVX-512 VNNI
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.22.2 for NVIDIA RTX 4090/L4/L40 (SM89) + AVX-512 VNNI [CUDA 12.9]";
