# ONNX Runtime 1.24.2 for NVIDIA Ada (SM89: RTX 4090/L4/L40) + AVX-512 BF16
...
let
  ...
  variantName = "onnxruntime-python313-cuda12_4-sm89-avx512bf16";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.24.2 for NVIDIA RTX 4090/L4/L40 (SM89) + AVX-512 BF16 [CUDA 12.4]";
