# ONNX Runtime 1.18.1 for NVIDIA Ada (SM89: RTX 4090, L4, L40) + AVX-512 BF16
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.18.1 for NVIDIA RTX 4090/L4/L40 (SM89) + AVX-512 BF16 [CUDA 12.4]";
