# ONNX Runtime 1.20.1 for NVIDIA Hopper (SM90: H100, L40S) + AVX-512 VNNI
...
let
  ...
  variantName = "onnxruntime-python313-cuda12_9-sm90-avx512vnni";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.20.1 for NVIDIA H100/L40S (SM90) + AVX-512 VNNI [CUDA 12.9]";
