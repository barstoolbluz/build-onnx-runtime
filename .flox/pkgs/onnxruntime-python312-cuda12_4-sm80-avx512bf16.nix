# ONNX Runtime 1.18.1 for NVIDIA Ampere DC (SM80: A100, A30) + AVX-512 BF16
...
let
  ...
  variantName = "onnxruntime-python312-cuda12_4-sm80-avx512bf16";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python312Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.18.1 for NVIDIA A100/A30 (SM80) + AVX-512 BF16 [CUDA 12.4]";
