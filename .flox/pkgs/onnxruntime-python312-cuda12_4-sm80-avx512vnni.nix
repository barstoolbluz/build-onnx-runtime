# ONNX Runtime 1.20.1 for NVIDIA Ampere DC (SM80: A100, A30) + AVX-512 VNNI
...
let
  ...
  variantName = "onnxruntime-python312-cuda12_4-sm80-avx512vnni";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python312Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.20.1 for NVIDIA A100/A30 (SM80) + AVX-512 VNNI [CUDA 12.4]";
