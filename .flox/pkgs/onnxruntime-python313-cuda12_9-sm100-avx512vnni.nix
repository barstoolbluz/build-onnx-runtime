# ONNX Runtime 1.24.2 for NVIDIA Blackwell DC (SM100: B100/B200) + AVX-512 VNNI
...
let
  ...
  variantName = "onnxruntime-python313-cuda12_9-sm100-avx512vnni";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.24.2 for NVIDIA B100/B200 (SM100) + AVX-512 VNNI [CUDA 12.9]";
