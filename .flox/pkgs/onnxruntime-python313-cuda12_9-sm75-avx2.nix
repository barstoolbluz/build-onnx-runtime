# ONNX Runtime 1.19.2 for NVIDIA Turing (SM75: T4, RTX 2080 Ti) + AVX2
...
let
  ...
  gpuArchCMake = "75";
  cpuFlags = [ "-mavx2" "-mfma" ];
  variantName = "onnxruntime-python313-cuda12_9-sm75-avx2";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.19.2 for NVIDIA T4/RTX 2080 Ti (SM75) + AVX2 [CUDA 12.9]";
