# ONNX Runtime 1.24.2 for NVIDIA Blackwell (SM120: RTX 5090) + AVX2
...
let
  ...
  gpuArchCMake = "120";
  cpuFlags = [ "-mavx2" "-mfma" ];
  variantName = "onnxruntime-python313-cuda12_4-sm120-avx2";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.24.2 for NVIDIA RTX 5090 (SM120) + AVX2 [CUDA 12.4]";
