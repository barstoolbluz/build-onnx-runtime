# ONNX Runtime 1.22.2 for NVIDIA Turing (SM75: T4, RTX 2080 Ti) + AVX-512 BF16
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.22.2 for NVIDIA T4/RTX 2080 Ti (SM75) + AVX-512 BF16 [CUDA 12.4]";
