# ONNX Runtime 1.23.2 for NVIDIA Blackwell (SM120: RTX 5090) + AVX-512 BF16
...
let
  ...
  variantName = "onnxruntime-python313-cuda12_4-sm120-avx512bf16";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.23.2 for NVIDIA RTX 5090 (SM120) + AVX-512 BF16 [CUDA 12.4]";
