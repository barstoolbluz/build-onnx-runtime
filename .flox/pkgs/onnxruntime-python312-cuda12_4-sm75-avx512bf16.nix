# ONNX Runtime 1.18.1 for NVIDIA Turing (SM75: T4, RTX 2080 Ti) + AVX-512 BF16
...
let
  ...
  variantName = "onnxruntime-python312-cuda12_4-sm75-avx512bf16";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python312Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.18.1 for NVIDIA T4/RTX 2080 Ti (SM75) + AVX-512 BF16 [CUDA 12.4]";
