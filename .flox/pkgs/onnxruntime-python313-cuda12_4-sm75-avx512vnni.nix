# ONNX Runtime 1.18.1 for NVIDIA Turing (SM75: T4, RTX 2080 Ti) + AVX-512 VNNI
...
let
  ...
  variantName = "onnxruntime-python313-cuda12_4-sm75-avx512vnni";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.18.1 for NVIDIA T4/RTX 2080 Ti (SM75) + AVX-512 VNNI [CUDA 12.4]";
