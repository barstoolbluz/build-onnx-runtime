# ONNX Runtime 1.22.2 for NVIDIA Ampere (SM86: RTX 3090, A40) + AVX2
...
let
  ...
  gpuArchCMake = "86";
  cpuFlags = [ "-mavx2" "-mfma" ];
  variantName = "onnxruntime-python312-cuda12_4-sm86-avx2";
  # ────────────────────────────────────────────────────────────────────
...
in
  (nixpkgs_pinned.python312Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.22.2 for NVIDIA RTX 3090/A40 (SM86) + AVX2 [CUDA 12.4]";
