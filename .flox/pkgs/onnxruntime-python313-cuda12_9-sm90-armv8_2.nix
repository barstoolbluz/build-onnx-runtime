# ONNX Runtime 1.20.1 for NVIDIA Hopper (SM90: H100/Grace Hopper) + ARMv8.2 (Graviton2)
...
in
  (nixpkgs_pinned.python3Packages.onnxruntime.override {
    ...
    pname = variantName;
    meta = oldAttrs.meta // {
      description = "ONNX Runtime 1.20.1 for NVIDIA H100/Grace Hopper (SM90) + ARMv8.2 (Graviton2) [CUDA 12.9]";
